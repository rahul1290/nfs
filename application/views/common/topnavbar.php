...
<nav class="main-header navbar navbar-expand navbar-white navbar-light text-center">
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav">
		<li class="nav-item" style="color: #fff;font-size: 22px;font-weight: bold;">
		<b>NEWSFLOW</b>
  </li>
	...
	<ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown resize-pic">
        <a class="nav-link" href="<?php echo base_url('Auth/profile'); ?>" aria-expanded="false">
         <?php 
					...
					<?php } ?>  <?php echo $this->session->userdata('username');?>
